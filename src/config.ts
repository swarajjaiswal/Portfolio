export const config = {
    ...
    social: {
        github: "swarajjaiswal",
        email: "swaraj93310@gmail.com",
        location: "India"
    },
    about: {
        title: "About Me",
        description: "I am a self-driven developer and AI enthusiast from India with a strong focus on computer science and scalable software systems. I build full-stack web applications and intelligent solutions using React, Next.js, Node.js, MongoDB, TypeScript, and Python. With a competitive programming mindset, I approach problems analytically and efficiently. I am exploring AI agents, automation, and data-driven systems. Code is precision. Systems are design. Intelligence is the goal."},
    ...
    period: "2025",
    location: "India",
    description: "Analyzed structured and unstructured data to generate actionable insights. Built dashboards, performed statistical analysis, and supported data-driven decision-making for various projects and clients.",
    responsibilities: [
        "Cleaning, transforming, and analyzing large datasets",
        "Creating interactive dashboards and reports",
        "Performing exploratory data analysis (EDA) and statistical modeling",
        "Writing SQL queries to extract and manipulate data",
        "Presenting insights and recommendations to stakeholders"
    ],
    technologies: ["Python", "Pandas", "NumPy", "SQL", "Power BI", "Excel", "Matplotlib"]
},
        {
    ...
    contact: {
        email: "swaraj93310@gmail.com",
        github: "https://github.com/swarajjaiswal/",
        linkedin: "https://www.linkedin.com/in/swaraj-jaiswal-0b5304283/",
        twitter: "https://x.com/_swarajjaiswal_",
        facebook: "https://www.facebook.com/swarajjaiss",
        instagram: "https://www.instagram.com/_swaraj_jaiswal_?igsh=OXZ0a3Vtb20wZ2di"
    },
    skills: {
                design: {
            title: "FULL-STACK",
